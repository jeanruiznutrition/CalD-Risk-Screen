...
function App() {
    ...
    const exportarExcel = () => {
        ...
        csv += "CalD Risk Screen - Resultados del Algoritmo CARDA v2.5\r\n";
        ...
        <div class="min-h-screen flex flex-col">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="font-bold text-lg leading-tight text-slate-900 dark:text-white flex items-center gap-2">
                                CalD Risk Screen
                                <span class="text-xs font-semibold px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300">CARDA v2.5</span>
                            </h1>
            ...
            <main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
                ...
                <div class="hidden print-only mt-12 p-8 border border-slate-300 rounded-3xl bg-white text-slate-900 space-y-6">
                    ...
                    <p class="pt-4 border-t border-slate-200 text-[10px] text-slate-400 text-center">© 2026 Jean Carlos Ruiz Mosley. Todos los derechos reservados. CalD Risk Screen (CARDA v2.5).</p>
                </div>
