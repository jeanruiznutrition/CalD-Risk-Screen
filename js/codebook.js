...
const DICCIONARIO_DATOS = [
    ...
    // --- Puntaje óseo simple y tiempo de exposición ---
    { campo: 'riesgoOseoSimplePuntaje', etiqueta: 'Puntaje óseo usando solo calcio y vitamina D', tipo: 'entero', rangoValido: '0-4', origen: 'calculado',
      nota: 'Existe para que el estudio determine si los demás componentes aportan capacidad predictiva sobre la densitometría. Si no la aportan, la versión publicable del instrumento es la corta.' },
    { campo: 'riesgoOseoSimpleFraccion', etiqueta: 'Fracción del máximo del puntaje simple', tipo: 'decimal', unidad: '%', origen: 'calculado' },
    { campo: 'riesgoOseoSimpleCategoria', etiqueta: 'Categoría del puntaje simple', tipo: 'categorico', origen: 'calculado',
      codificacion: 'bajo | moderado | alto' },
    { campo: 'mesesSuplementoCalcio', etiqueta: 'Tiempo suplementando calcio', tipo: 'entero', unidad: 'meses', origen: 'capturado',
      nota: 'La presencia de suplemento sin su duración no distingue a quien empezó ayer de quien lleva años.' },
    { campo: 'mesesSuplementoVitD', etiqueta: 'Tiempo suplementando vitamina D', tipo: 'entero', unidad: 'meses', origen: 'capturado',
      nota: 'La 25-hidroxivitamina D sérica tarda del orden de tres meses en alcanzar el estado estacionario: por debajo de ese tiempo el valor sérico no refleja aún la dosis que se está tomando.' },
    { campo: 'mesesEntrenamientoRegular', etiqueta: 'Tiempo entrenando con regularidad', tipo: 'entero', unidad: 'meses', origen: 'capturado',
      nota: 'La respuesta ósea al ejercicio con resistencia se mide en meses.' },
