...
// Orden y banderas definidos por el autor. El español usa la bandera de
// Panamá y su redacción es de español latinoamericano, no peninsular.
const IDIOMAS_DISPONIBLES = [
    { id: 'es', nombre: 'Español',   nombreIngles: 'Spanish',    bandera: '🇵🇦' },
    { id: 'en', nombre: 'English',   nombreIngles: 'English',    bandera: '🏴󠁧󠁢󠁥󠁮󠁧󠁿' },
