...
try {
    ...
    const pruebaDePaneles = `
        ...
        // Paneles nuevos de la v6.0: interpretación de laboratorio y
        // bibliografía. El de bibliografía se genera DESDE el registro de
        // parámetros, así que este render también comprueba que ese
        // registro es recorrible y que sus grados tienen traducción.
        PanelLaboratorio({ t });
        PanelBibliografia({ t });
        return 11;
    `;
